"""
Django settings for DRestfull project.
...
SECRET_KEY = '@)h7$4pdc=26af*$#!7oycli5_x&c3^=uj8rv(ph9_1sr^(ft)'
...
WSGI_APPLICATION = 'DRestfull.wsgi.application'
